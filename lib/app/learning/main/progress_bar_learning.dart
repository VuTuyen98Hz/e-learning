...
class ProgressBarLearning extends StatefulWidget {
  const ProgressBarLearning(
  ...
  @override
  State<ProgressBarLearning> createState() => _ProgressBarLearningState();
}

class _ProgressBarLearningState extends State<ProgressBarLearning>
